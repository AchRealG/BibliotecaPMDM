...
import com.example.bibliotecapmdm.databinding.FragmentLoginBinding
...
class LoginFragment : Fragment(R.layout.fragment_login) {
    ...
    private fun cargarLogicaInicioSesion() {
        ...
        // Recuperar los datos guardados en SharedPreferences usando los recursos de strings
        ...
        // Cuando se pulse el texto para registro, se cambia la vista
